...
def main(args):
    ...
    # get dataset
    dataset_train = build_conmim_pretraining_dataset(args)
    ...
    model_copy_without_ddp.load_state_dict(model.module.state_dict(), strict=False)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            if (epoch + 1) % args.save_ckpt_freq == 0 or epoch + 1 == args.epochs:
                ...
                utils.save_model_copy(
                    args=args, model=model_copy, model_without_ddp=model_copy_without_ddp, optimizer=optimizer,
                    loss_scaler=loss_scaler, epoch=epoch)
